	...
	public static void main(String[] args){
		...
		if (inf_expr.length()!=0){
			for (int i = 0 ; i<inf_expr.length() ; i++) {
				...
				// System.out.println("Token: "+inf_expr.charAt(i)+" Top of Stack: "+sa4.peek()+" cur_pos: "+pos_expr);
			}

			while (sa4.Size()>0) {
				pos_expr += sa4.pop();
				// System.out.println("Token:   Top of Stack: "+sa4.peek()+" cur_pos: "+pos_expr);
			}

			System.out.println("\nPostfix Expression: "+pos_expr+"\n");
		}
		else {
